...
5. [Everything working off of the battery -- &#9989; V1 doc DONE](./doc/battery_powered.md): In the previous task only the DC motor was working off of the battery. Now lets get everything working all off of the battery.
